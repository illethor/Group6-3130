...
public class FitnessRegisterActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    startActivity(new Intent(FitnessRegisterActivity.this, FitnessMainActivity.class));
                } else {
                    // User is signed out
        ...
        btnRegister.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (TextUtils.isEmpty(txtEmail.getText())){
                    Toast.makeText(FitnessRegisterActivity.this, R.string.emailEmpty, Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(txtPassword.getText())){
                    Toast.makeText(FitnessRegisterActivity.this, R.string.passwordEmpty, Toast.LENGTH_SHORT).show();
                } else if (txtPassword.getText().toString().length() <= 5){
                    Toast.makeText(FitnessRegisterActivity.this, R.string.passwordTooSmall, Toast.LENGTH_SHORT).show();
                    ...
                    databaseArtists.child(cleanEmail(txtCoachEmail)).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(!alreadyRegistered) {
                                if (objUser == null) {
                                    Toast.makeText(FitnessRegisterActivity.this, R.string.coachEmailDNE, Toast.LENGTH_SHORT).show();
                                } else if (!objUser.getCoach()) {
                                    // Coach email is a valid user email however it's not a coach
                                    Toast.makeText(FitnessRegisterActivity.this, R.string.userNotACoach, Toast.LENGTH_SHORT).show();
                                } else if (!objUser.getAtheleteEmail().equals("")) {
                                    // Coach is already assigned to a user
                                    Toast.makeText(FitnessRegisterActivity.this, R.string.coachHasAthelete, Toast.LENGTH_SHORT).show();
                                } else {
                                    registerUser();
                                }
                            }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>(){
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task){
                        if (!task.isSuccessful()){
                            Toast.makeText(FitnessRegisterActivity.this, R.string.registrationFailed, Toast.LENGTH_SHORT).show();
                        } else {
                            User objUser;
